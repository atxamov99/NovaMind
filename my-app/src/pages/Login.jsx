    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-dark-bg p-4 flex-col">
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 dark:text-gray-400">Gemini AI xizmatiga ulanish uchun tizimga kiring</p>
        </div>
        ...
        <div className="bg-white dark:bg-dark-panel p-8 rounded-2xl shadow-xl border border-gray-100 dark:border-dark-border">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-2 bg-linear-to-r from-primary-600 to-secondary-600 hover:from-primary-500 hover:to-secondary-500 text-white py-3 px-4 rounded-xl font-medium transition-all shadow-md shadow-primary-500/20 disabled:opacity-70 disabled:cursor-not-allowed group"
            >
              {isLoading ? (
